  ...
  while (fuel > 0) {
	  ...
	  if (!wantPause)
		  ...
		  if (fuel > 0)
		{
		  ...
		  for (i = 0; i < NUM_p2; i++)
			{
			  p2[i].position[0] += p2[i].speed[0] * 0.1;
			  p2[i].position[1] += p2[i].speed[1] * 0.1;
			  p2[i].position[2] += p2[i].speed[2] * 0.1;
		      
			  p2[i].orientation[0] += p2[i].orientationSpeed[0] * 10;
			  p2[i].orientation[1] += p2[i].orientationSpeed[1] * 10;
			  p2[i].orientation[2] += p2[i].orientationSpeed[2] * 10;
			}
